"""Direct joint transmission strategy for fully-actuated hands (LEAP, Allegro)."""
...
class DirectJointTransmission(TransmissionModel):
    """Direct 1-to-1 transmission where each actuator directly drives a single joint."""
    ...
    def __init__(
        ...
        # Precompute static moment matrix
