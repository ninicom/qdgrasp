    ...
    cells = [
        ...
        },
        {
            ...
            "source": [
                ...
                "subprocess.run(['pytest', '-v', '/tmp/qdgrasp_repo/tests/test_characterization_harness.py', '/tmp/qdgrasp_repo/tests/test_dataset_contracts.py', '/tmp/qdgrasp_repo/tests/test_generated_reachable.py', '/tmp/qdgrasp_repo/tests/test_palm_hypotheses.py', '/tmp/qdgrasp_repo/tests/test_collision_admission.py', '/tmp/qdgrasp_repo/tests/test_task_space_command.py', '/tmp/qdgrasp_repo/tests/test_dynamic_predicate.py', '/tmp/qdgrasp_repo/tests/test_canonical_full_flow.py'], env=env, check=True)\n",
